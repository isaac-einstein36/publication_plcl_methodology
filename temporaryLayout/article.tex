...
\title{Novel Single Screw Extrusion Methodology of PLCL Copolymer} % Article title, use manual lines breaks (\\) to beautify the layout

% Authors are listed in a comma-separated list with superscript numbers indicating affiliations
% \thanks{} is used for any text that should be placed in a footnote on the first page, such as the corresponding author's email, journal acceptance dates, a copyright/license notice, keywords, etc
\author{%
	Isaac Einstein\textsuperscript{1}, Adrian Bakhtar\textsuperscript{1} and Dr. Sandra Anstaett Metzler, D.Sc., P.E.\textsuperscript{1}\thanks{Corresponding author: \href{mailto:metzler.136@osu.edu}{metzler.136@osu.edu}\\ \textbf{Received:} October 20, 2023, \textbf{Published:} December 14, 2023}
}

% Affiliations are output in the \date{} command
\date{\footnotesize\textsuperscript{\textbf{1}}Department of Mechanical Engineering, The Ohio State University}
